...
export const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ADD_TO_WISHLIST:
            return { ...state, isLoading: false, wishlist: [...state.wishlist, action.payload] }
        default:
            return state;
    }
}