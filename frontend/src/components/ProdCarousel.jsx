                ...
                <Box sx={{ position: 'relative' }}>
                    ...
                    >
                        {carouselData.map((ele) => (
                            <img style={{ cursor: 'pointer' }} onClick={() => navigate(ele.redirect_to)} key={ele.text} src={ele.url} alt={ele.text} />
                        ))}
                    </StyledBox>
                    <Button
                        onClick={scrollRight}
